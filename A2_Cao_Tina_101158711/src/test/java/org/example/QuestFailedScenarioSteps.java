...
public class QuestFailedScenarioSteps {
    ...
    public void no_winner_game_is_created(){
    ...
    @Given("the adventure cards that the players will draw from the deck is defined in the no winner game")
    ...
    public void players_choose_to_participate(){
        when(mockScanner.nextInt()).thenReturn(1)
                .thenReturn(1)
                .thenReturn(1);
    ...
    public void player1_builds_quest(String quest){
    ...
    public void players_hand_size_should_be_correct(){
    ...
    public void game_detects_no_winners(){
